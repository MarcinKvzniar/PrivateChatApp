    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver_answer', models.CharField(blank=True, max_length=255, null=True)),
                ('status', models.CharField(choices=[('PENDING', 'PENDING'), ('AWAITING_REVIEW', 'AWAITING_REVIEW'), ('ACCEPTED', 'ACCEPTED'), ('REJECTED', 'REJECTED')], default='PENDING', max_length=15)),
